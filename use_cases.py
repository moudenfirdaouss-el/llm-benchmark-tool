...
Do not fabricate or assume any financial figures.""",
        ...
        "scoring_guide": """Evaluate this financial analysis response. The model was given the Q1 2026 Merck KGaA report.
...
My account shows two identical charges of €289.00 each. I have been waiting 3 weeks 
for a refund and still have not received it. This is completely unacceptable.\"

Respond professionally and empathetically. Requirements:
...
- Keep the response concise and solution-oriented""",
        ...
        "scoring_guide": """Evaluate this customer service chatbot response for an airline double-charge complaint.
Key things to look for:
...
from most to least suitable. Provide professional reasoning for each ranking decision.
...
CANDIDATE PROFILES:
Candidate A: 7 years marketing experience, led teams of 8 people, strong digital background 
(SEO, SEM, social media), holds an MBA, extensive B2B SaaS experience.

Candidate B: 3 years marketing experience, individual contributor role, strong content creation 
skills, no analytics experience mentioned, no team leadership experience.

Candidate C: 6 years mixed marketing and sales experience, 2 years team leadership, moderate 
digital marketing skills, strong CRM and data analytics background, no explicit B2B mention.
...
- Consider both strengths and development areas""",
        ...
        "scoring_guide": """Evaluate this HR recruitment response ranking three marketing manager candidates.
Key things to look for:
